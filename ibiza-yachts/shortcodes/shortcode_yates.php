<?php  // [grid-yates qty="9"]

function shortcode_yates_ibz($atts){ 
		...
		<div class="ibz-yatch">	
			...
			<div class="ibz-yatch_short-description"> 
				...
				<div class="wrap_short-descrip">
					<?php echo wp_trim_words( get_field('descripcion_corta'), 28, '...' ); ?> 
				</div>
			</div>
		</div>		
...
add_shortcode( 'grid-yates', 'shortcode_yates_ibz' ); 